...
```{r echo=FALSE}
mydata.overloaded <- read_csv("./QC.output.new.Bacteria_HILIC_160613_1to2_update_13cacetylcoa_akb.csv")
...
ggplot(sub, aes(x=Compound.Name, y=rsd, 
     ...
     scale_shape_manual(values=c(19,19,19,15,15,15,17,17,17,17)) +
     scale_colour_manual(values=c("#e41a1c","#984ea3","#4daf4a",
...
## Save out rsd data
```{r}
write.csv(long.rsd, file = "HILIC_1to2_RSD_NormalizationComparison_pool0614.csv")

write.csv(dat, file = "HILIC_1to2_data_NormalizationComparison.csv")
```
